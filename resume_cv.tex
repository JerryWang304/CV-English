...
\mobile{(+86) 18930902061}

\email{wangfeng2@shanghaitech.edu.cn}
...
%\makecvfooter{\today}{Feng Wang}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
[1] \underline{Feng Wang}, Fu Song, Min Zhang, Xiaoran Zhu and Jun Zhang, ``KRust: A Formal Executable Semantics of Rust'', ,International Conference on Theoretical Aspects of Software Engineering, Guangzhou, China, 2018

[2] Jianmin Bao, \underline{Feng Wang}, Junjie Zhang, Shu Zhang and Kun Wang, ``Secure Multi-period Routing in the Delay Tolerant Networks'', International Conference on Wireless Communication and Sensor Network, Wuhan, China, 2014
